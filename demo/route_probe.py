...
PROBES = [
    ...
    ("single / should-NOT-trigger", "single", "find the airport", "ground+vqa — presence-gated box (post GROUND-v1); watch water_highlight over-selection"),
    ("single / should-NOT-trigger", "single", "what's the runway doing here", "prose only — watch over-selection"),
    ("single / refusal integrity", "single", "highlight the buildings", "ground+vqa — presence-gated (was a refusal pre-GROUND-v1)"),
